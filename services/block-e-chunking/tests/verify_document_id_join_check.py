...
# Use SQLite for testing (no external infrastructure required)
os.environ['DATABASE_URL'] = 'sqlite:///test_document_id_join_check.db'
...
def test_document_id_join_check():
    ...
    print("\n[0] Creating tables for SQLite test...")
