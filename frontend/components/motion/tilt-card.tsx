...
export function TiltCard({ children, max = 12, glare = true, className }: TiltCardProps) {
  ...
  // Glare is a *highlight* — it has to be lighter than the surface it crosses.
  // Painting --foreground here smeared a dark blob across every light card.
  const glareBg = useMotionTemplate`radial-gradient(circle at ${gx}% ${gy}%, oklch(1 0 0 / 0.9), transparent 55%)`;
